...
class ApiService {
  static const String _baseUrl = 'https://script.google.com/macros/s/AKfycbzgETkWxISx1Qyn_x8_QyATsFk_glXeFfkjJME2rtoMiKMJkkMuctn_lHkzp7DPuVgvng/exec';

  // 🔐 Login
  static Future<Map<String, dynamic>?> login(String username, String password) async {
    final uri = Uri.parse('$_baseUrl?action=login&username=$username&password=$password');
